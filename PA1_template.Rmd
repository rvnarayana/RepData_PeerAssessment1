...
####Mean value of Total Number of Steps Daily =  `r mean(q1$TotalSteps)`  

####Median value of Total Number of Steps Daily = `r median(q1$TotalSteps)`
...
```
####The interval with Maximum Average Steps = `r q2$interval[maxIndx]`  



## 4. Imputing missing values   

#### Number of Intervals with missing values = `r sum(is.na(measures$steps))`
...
####Mean value of Total Number of Steps Daily =  `r format(mean(q5$TotalSteps), 2,format=f)` 

####Median value of Total Number of Steps Daily = `r format(median(q5$TotalSteps), 2, format=f)`  
